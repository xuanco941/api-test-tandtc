...
let AppController = class AppController {
    ...
    async Prompt(promptDto) {
        const files = [
            { filePath: path_1.default.join(__dirname, "assets", "hp-2013.pdf"), name: "hien-phap" },
            { filePath: path_1.default.join(__dirname, "assets", "luat-can-bo-2025.pdf"), name: "luat-can-bo-2025" },
            { filePath: path_1.default.join(__dirname, "assets", "luat-to-chuc-toa-an.pdf"), name: "luat-to-chuc-toa-an" },
            { filePath: path_1.default.join(__dirname, "assets", "toa-an-sua-doi-2025.pdf"), name: "toa-an-sua-doi-2025" }
        ];
